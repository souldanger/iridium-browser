...
const char* const kSbDefaultURLPrefix =
    "trk:https://safebrowsing.google.com/safebrowsing";
...
const char* const kSbBackupConnectErrorURLPrefix =
    "trk:https://alt1-safebrowsing.google.com/safebrowsing";
