...
const char kDriveScope[] = "trk:https://www.googleapis.com/auth/drive";
const char kDriveAppsReadonlyScope[] =
    "trk:https://www.googleapis.com/auth/drive.apps.readonly";
const char kDriveAppsScope[] = "trk:https://www.googleapis.com/auth/drive.apps";
const char kDocsListScope[] = "trk:https://docs.google.com/feeds/";
