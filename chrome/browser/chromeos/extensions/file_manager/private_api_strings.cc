...
void AddStringsForGallery(base::DictionaryValue* dict) {
  ...
  SET_STRING("GALLERY_FILE_HIDDEN_NAME", IDS_FILE_BROWSER_ERROR_HIDDEN_NAME);
...
bool FileManagerPrivateGetStringsFunction::RunSync() {
  ...
  SET_STRING("CLOUD_IMPORT_INSUFFICIENT_SPACE_BUTTON_LABEL",
             IDS_FILE_BROWSER_CLOUD_IMPORT_INSUFFICIENT_SPACE_BUTTON_LABEL);
  SET_STRING("CLOUD_IMPORT_SCANNING_BUTTON_LABEL",
             IDS_FILE_BROWSER_CLOUD_IMPORT_SCANNING_BUTTON_LABEL);
